...
import "./InternalFactory.sol";
import "./IInternalPair.sol";
// import "../tax/IBondingTax.sol";

contract InternalRouter is
    Initializable,
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function buy(
        ...
        IInternalPair(pair).transferTo(to, amountOut);

        IInternalPair(pair).swap(0, amountOut, amount, 0);
    ...
    function approval(
        ...
        IInternalPair(pair).approval(spender, asset, amount);
    }
