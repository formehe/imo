...
contract InternalPair is IInternalPair, ReentrancyGuard {
    ...
    function transferTo(address recipient, uint256 amount) public override onlyRouter {
        require(recipient != address(0), "Zero addresses are not allowed.");
    ...
    function kLast() public view override returns (uint256) {
        return _pool.k;
    }
